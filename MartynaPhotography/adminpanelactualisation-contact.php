...
<h1>Aktualizowanie sekcji "Kontakt"</h1>
<input name="name" type="text" placeholder="Podaj imie i nazwisko"/>
<input name="adres" type="text" placeholder="Podaj Adres"/>
<input name="email" type="text" placeholder="Podaj e-mail"/>
<input style ="display:none;" name="check" type="number=" value="6"/>
