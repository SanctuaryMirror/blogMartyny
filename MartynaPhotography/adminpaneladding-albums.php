...
<p><input id="titleinput" maxlength="255" type="text" name="title" placeholder="wstaw nazwę albumu do 255 znaków"></input></p>
<input style ="display:none;" name="check" type="number=" value="3"/>
